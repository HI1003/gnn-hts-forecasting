"""TALP backbone: GATv2Conv + GRU + projection."""
...
class TALP(nn.Module):
    """Generate normalized log-space base forecasts using GATv2Conv and GRU."""
    ...
    def forward(self, x: torch.Tensor, edge_index: torch.Tensor) -> torch.Tensor:
        ...
        for t in range(timesteps):
            ...
            for layer_idx, gat_layer in enumerate(self.gat_layers):
                step_out = gat_layer(step_out, batched_edge_index)
